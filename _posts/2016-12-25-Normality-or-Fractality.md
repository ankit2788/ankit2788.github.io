...
[gallery ids="23,24,41,42" type="slideshow" orderby="rand"]

Then why do we use a Normal distribution for price returns? It may be accurate 95% of the times, but the rest 5% can make an investment completely worthless. Just like '_a sailor wont take chances if he/ she knew that weather is going to be moderate _<u>_only_</u>_ 95% of the times_’, why should we settle with an approximation which may be accurate ONLY 95% of times?
...
So what exactly are **Fractals**? Simply speaking, Fractals are [self-similar](http://en.wikipedia.org/wiki/Self-similarity) structures that repeats themselves at every scale. In nature, we see it but we don’t observe it. A leaf exhibits fractal properties. The leaf in the below image contains many smaller leaflets . You zoom in further, you see a similar leaf. This goes on and on.

[caption id="attachment_25" align="aligncenter" width="481"]![The fractals of nature](https://globalspectre.files.wordpress.com/2016/09/5e0044922573f436e5e04c1e9e87c798.jpg?w=1024) A Fractal Leaf[/caption]
...
![aaeaaqaaaaaaaagfaaaajgzmotk4mwu3lwi4odytndhjys05ngewltmxmmyzmjq4yjuwyg](https://globalspectre.files.wordpress.com/2016/09/aaeaaqaaaaaaaagfaaaajgzmotk4mwu3lwi4odytndhjys05ngewltmxmmyzmjq4yjuwyg.png)

![aaeaaqaaaaaaaahfaaaajgi1ndbkm2uzlthin2itndk5yi1hzdhhlwqxyjaxn2rmzjm4za](https://globalspectre.files.wordpress.com/2016/09/aaeaaqaaaaaaaahfaaaajgi1ndbkm2uzlthin2itndk5yi1hzdhhlwqxyjaxn2rmzjm4za.png)
...
Self-similarity (or affinity) isn’t the only _cool_ feature of Fractals. It gives rise to [Fractal dimensions](http://en.wikipedia.org/wiki/Fractal_dimension), dimensions which are not defined in Euclidean space. A point, for example, doesn't have any dimensions; a line is 1-D, a cube is a 3-dimension structure. What about a [_Koch curve_](http://en.wikipedia.org/wiki/Koch_snowflake) (or a snowflake) or [_Cantor dust_](http://en.wikipedia.org/wiki/Cantor_set)? A repetitive information in Koch curve makes it more complex than 1-D figure but its not exactly a 2-D structure. Fractal geometry gives it a dimension of 1.26, a fractional number.

![aaeaaqaaaaaaaaffaaaajgy2yzc1mti4ltc3ndctndq5zs1indrjltqwzmjlowi5nzaxyw](https://globalspectre.files.wordpress.com/2016/09/aaeaaqaaaaaaaaffaaaajgy2yzc1mti4ltc3ndctndq5zs1indrjltqwzmjlowi5nzaxyw.png)
...
Benoit Mandelbrot, in his revolutionary paper on _Multifractal Model of Asset returns(MMAR),_ talks about this dynamic Fractal dimensions in detail. Mandelbrot presented the below image in his article “_Multifractal walk down the wall street_”, and asked the readers to differentiate between various time series. ![](https://media.licdn.com/mpr/mpr/AAEAAQAAAAAAAAkVAAAAJGU4NjNmNjI3LTQ0M2ItNDI5NC04NGY4LWNhMmM2ZWQ0NDNhNA.png)
