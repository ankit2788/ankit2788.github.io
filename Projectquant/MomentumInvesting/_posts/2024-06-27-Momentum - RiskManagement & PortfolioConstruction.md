...
In the [last article](/projectquant/momentuminvesting/2024-06-25-The-Base-Momentum-Portfolio/), we analyzed risk and returns of prototype Momentum factors. There are a number of risks associated to investing in individual Momentum factors. For instance, these factors have negative skewness, i.e. they entail a heavy left tail risk. 
